...
void computeLightComponents() {     
    ...
    vec3 pointPosEye = (view * vec4(lightDir, 1.0f)).xyz; // Transform light position to eye space
    ...
    vec3 lightColorPoint = lightColor * 2.0; 
...
float computeShadow() {
    ...
    normalizedCoords = normalizedCoords * 0.5 + 0.5; // Convert to [0,1] range
    ...
    // Bias pentru a evita umbrele false (self-shadowing)
